...
# Define el contenido HTML como una cadena de texto
html_content = ''''From - Fri Aug 18 06:25:23 2017
...
Calibri,Arial,Helvetica,sans-serif,&quot;EmojiFont&quot;,&quot;Apple
        ...
        <hr style="width:320px; height:4px; border-width:0px;
...
def find_information(keyword):
    # Buscar todas las divisiones con atributo 'dir' igual a 'ltr'
    text_divisions = soup_parser.find_all('div', {'dir': 'ltr'})
    for div in text_divisions:
        # Obtener el texto de la división
        div_text = div.get_text()
        # Buscar insensiblemente respecto a mayúsculas y minúsculas
        if keyword.lower() in div_text.lower():
            # Dividir el texto en líneas
            lines = div_text.split('\n')
            for line in lines:
                if keyword.lower() in line.lower():
                    # Imprimir la línea que contiene la palabra clave
                    print(line)

# Ejemplos de búsqueda
find_information('matricula')
print('\n')
find_information('fecha de matriculación')
print('\n')
find_information('color')
print('\n')
find_information('marca')
print('\n')
find_information('modelo')
print('\n')
find_information('caída')
